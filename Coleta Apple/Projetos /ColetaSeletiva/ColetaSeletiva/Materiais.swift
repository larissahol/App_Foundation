...
let InicioTexto: [Inicio] = [
    Inicio(icone: Image(systemName: "house"), material: "Início", texto: "Bem-vindo à Coleta Apple! Este aplicativo é um guia para realizar a separação de materiais para a coleta seletiva.")
]
...
let SobreTexto: [Sobre] = [
    Sobre(icone: Image(systemName: "info.circle"), material: "Sobre", texto: "O Aplicativo Coleta Apple tem como objetivo ensinar sobre como realizar a coleta seletiva.")
]
